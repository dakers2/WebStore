...
VALUES 
	...
	(0, 100, 'Strawberry Cake',	23.99, 'No sumo adipisci mea, per te percipit fabellas. Nec nusquam intellegat et. Eam nibh dolores aliquando no. Id verear eripuit.', 'cake-strawberry2.jpg', 2),
	(1, 100, 'French Cake',	9.00, 'Mel civibus placerat in. Eos id nullam graecis deseruisse, ne amet hinc vix. Ne vel impetus pericula, docendi blandit oporteat.',	'france-cake.jpg', 2),
	(0, 100, 'Cupcakes', 3.99,	'Usu elit hendrerit reformidans eu, et nusquam tacimates quo. Melius iriure minimum est ut. His ad laudem appetere ponderum, soluta.', 'cake-cupcake.jpg', 2),
	(1, 200, 'Cake Pops', 1.00,	'Pro te maluisset patrioque, sea quot moderatius no, per prima aliquam impedit te. Ei mei harum ponderum, sed eu odio.', 'cake-pops.jpg', 2),
	(1, 600, 'Chocolate Chip', 6.00, 'Pro te maluisset patrioque, sea quot moderatius no, per prima aliquam impedit te. Ei mei harum ponderum, sed eu odio.', 'choc-chip.jpg', 1),
	(1, 300, 'Macaroons', 6.99, 'Sumo suas pri no, eam euismod deleniti ea, no amet perpetua accommodare ius. Scripta deserunt per id, inani movet dolor.', 'cookie-2.jpg', 1),
	(1, 500, 'Sugar Cookies', 5.00, 'Mel tale labore id. Ex duo habemus fuisset, mei epicuri corrumpit temporibus at. Hinc persecuti ea vix, ei postea iriure.', 'cookie-1.jpg', 1),
	(0, 400, 'Cookie Dough', 6.99, 'Ei atqui copiosae instructior quo, eu vide tritani suavitate vis. Possim vidisse percipitur at est, ea usu vitae pertinax an.', 'cookie-dough.jpg', 1),
	(0, 300, 'Lemon Cookies', 5.00, 'An abhorreant dissentiunt per, efficiantur voluptatibus in vel. Per fierent mentitum ea, malis deserunt ullamcorper ex his.', 'cookies-3.jpg', 1),
	(0, 1000, 'Animal Cookies', 4.50, 'Ex vim libris aliquid reprehendunt, assum labitur periculis nam no. Nibh decore percipit vim in, at latine mentitum vim qui.', 'cookies-animals.jpg', 1),
	...
	(0, 450, 'Sugar Jellies', 3.50, 'Pro te maluisset patrioque, sea quot moderatius no, per prima aliquam impedit te. Ei mei harum ponderum, sed eu odio.', 'jelly.jpg', 3)

INSERT INTO Shipping (ShippingMethodId, Method, Price, DaysToShip)
VALUES (1, 'Standard (7 day)',7.99,7), (2, 'Express (3 day)', 12.99, 3), (3, 'Next Day (1 day)', 15.99, 1)
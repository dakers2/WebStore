...
namespace WebStore.Controllers
{
    ...
    {
        private WebStoreDatabaseEntities db = new WebStoreDatabaseEntities();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,Description,Price,Image,Quantity,CategoryId,Featured")] Product product)
        {
            if (ModelState.IsValid)
            {
